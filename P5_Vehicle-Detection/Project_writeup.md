...
Click the screenshot below to navigate to my final video output.
[![IMAGE ALT TEXT](./output_images/pipelineTest.png)](https://youtu.be/m5R33ddrpgY "Project Output")
